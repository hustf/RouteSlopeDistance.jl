...
@test isempty(nvdb_request(url_ext, "POST"; body))
...
#
@test !isempty(nvdb_request(url_ext, "POST"; body))
# This request was understood and we got a reply:
#     POST https://nvdbapiles.atlas.vegvesen.no/vegnett/api/v4/beta/vegnett/rute   \{}
#┌ Info: {
#│     "type": "about:blank",
#│     "title": "Bad Request",
...
o1 = nvdb_request(url_ext, "POST"; body)
...
@test isempty(nvdb_request(url_ext, "POST"; body)) # "message": "Expected SRID 5973, but was 5972"
pop!(body, :srid)
o2 = nvdb_request(url_ext, "POST"; body)
